      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-white/50">Entre na sua conta para continuar criando</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 rounded-xl bg-white/5 border text-white placeholder:text-white/30 outline-none transition-all focus:border-cyan-500/50 ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-11 pr-12 py-3 rounded-xl bg-white/5 border text-white placeholder:text-white/30 outline-none transition-all focus:border-cyan-500/50 ${
          ...
          <p className="text-center text-sm text-white/40 mt-8">
            Não tem uma conta?{" "}
            <Link href="/signup" className="text-cyan-400 hover:text-cyan-300">Criar conta grátis</Link>
          </p>
        </div>
      </div>
    </main>
